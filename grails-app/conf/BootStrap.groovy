...
class BootStrap {
    ...
    def init = { servletContext ->
		...
		def eventsList = []
		eventsList += new Event(Game.get(1)).save()
		eventsList += new Event(Game.get(2)).save()
		eventsList += new Event(Game.get(3)).save()

        new Location(events: eventsList, name: 'Botequim Informal - Via Brasil', description: 'Melhor chopp do Rio de Janeiro', address: 'Shopping Via Brasil - Rua Itapera, 500', location:[22.814795,-43.264847]).save()
